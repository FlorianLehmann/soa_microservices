...
echo `curl -o -I -L -s -w "%{http_code}" -d '{"name": "florian","restaurant": "soup restaurant","product": "ramen soup","location": "49.8987,78.4235","phone": "0666666666"}' -H "Content-Type: application/json" -X POST http://localhost:8083/orders/new_order`
echo
