...
echo `curl -o -I -L -s -w "%{http_code}" -d '{"name": "Gail","restaurant": "soup restaurant","product": "ramen soup","customerLocation": "60.8987,88.4235", "restaurantLocation": "60.8987,88.4235","phone": "0676666666"}' -H "Content-Type: application/json" -X POST http://localhost:8083/orders/new_order`
echo
